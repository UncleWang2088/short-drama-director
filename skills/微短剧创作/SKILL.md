---
name: "微短剧创作"
description: "爆款微短剧剧本全流程创作技能。当用户想要创作短剧、微短剧、竖屏短剧剧本、写分集、选题立项、付费卡点设计、短剧爽点设计、短剧出海时使用。覆盖选题→角色→分集大纲→逐集撰写→质量自检→合规审核→导出全流程，50-100集。基于爆款短剧工业方法论（爽点矩阵/节奏曲线/钩子设计/付费卡点）。"
---
